...
function SignUpPage() {
  ...
  return (
    <div>
      ...
      <Box w="500px" m="auto" border={style.border} borderRadius={style.borderRadius} p="5" mt="30">
        <form data-testid="form-element" >
          <FormControl>
            <FormLabel>Full Name</FormLabel>
            <Input type="text" name="name" placeholder="Enter Your Name" mb="2" border={style.border} />
