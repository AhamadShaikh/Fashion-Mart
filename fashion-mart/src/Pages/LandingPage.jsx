...
import { dashboardProduct, StaticImage1, StaticImage2, GetSearchData } from "../AllApi/Api";
...
function LandingPage() {
    ...
    const handleSearchClick = () => {
        GetSearchData(query).then((res) => setDashboardData(res?.data)).catch((err) => console.log(err));
    }

    return (
        <div>
            <Navbar handleSearch={handleSearch} handleSearchClick={handleSearchClick} />
            <div className='Images'>
                ...
                <Box className="image-card">
                    <button className='prev-btn'><Text>&lt;</Text></button>
                    {
                        images1?.map((ele) => (
                    ...
                    <button className='next-btn'><Text>&gt;</Text></button>
                </Box>
                <hr />
                <Box className="image-card">
                    <button className='prev-btn'><Text>&lt;</Text></button>
